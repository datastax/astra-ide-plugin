...
open class AstraClientBase(
    open var accessToken:String = ""
        ...
        fun schemasApiForCollection(database: Database): com.datastax.astra.stargate_document_v2.apis.SchemasApi {
            val basePath = database.dataEndpointUrl.orEmpty().removeSuffix(URI(database.dataEndpointUrl).rawPath)
            return com.datastax.astra.stargate_document_v2.infrastructure.ApiClient(
                baseUrl = basePath
            ).createService(com.datastax.astra.stargate_document_v2.apis.SchemasApi::class.java)
        }
